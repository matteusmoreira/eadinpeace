...
export default function EditQuestionPage() {
    ...
    const question = useQuery(api.questionBank.getById, { questionId: questionId as any });
    const updateQuestion = useMutation(api.questionBank.update);
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Editar Questão</h1>
                </div>
